...
cp "$platform/assets/screenshots/overview-light-1440.png" "$docs_root/site/assets/screenshots/"
cp "$platform/assets/screenshots/master-light-1440.png" "$docs_root/site/assets/screenshots/"
